# skills.py (or add this list near the top of app.py)
...
SKILLS_DB = [
    ...
    'pandas', 'numpy', 'scipy', 'scikit-learn', 'tensorflow', 'keras', 'pytorch', 'matplotlib', 'seaborn', 'plotly',
    'machine learning', 'deep learning', 'data science', 'data analysis', 'data visualization', 'nlp', 'natural language processing',
    'computer vision', 'big data', 'hadoop', 'spark', 'kafka', 'hive', 'hbase',
    ...
    'advocate', 'legal', 'law'
    # Add many more skills relevant to the categories you have
]